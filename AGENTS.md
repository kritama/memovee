...
- **Use daisyUI as the standard component library**. Prefer daisyUI component classes customized with Tailwind utilities, and write project-owned components only when daisyUI does not fit the product's needs
