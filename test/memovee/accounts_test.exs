defmodule Memovee.AccountsTest do
  use Memovee.DataCase

  alias Memovee.Accounts

  import Memovee.AccountsFixtures
  alias Memovee.Accounts.{Token, User}
  ...
  describe "deliver_user_update_email_instructions/3" do
    ...
    test "sends token through notification", %{user: user} do
      ...
      assert user_token.actor_id == user.actor_id
  ...
  describe "update_user_email/2" do
    ...
    test "does not update email with invalid token", %{user: user} do
      ...
      assert Repo.get_by(Token, actor_id: user.actor_id)
    end
    ...
    test "generates a token", %{user: user} do
      ...
      assert_raise Ecto.ConstraintError, fn ->
        Repo.insert!(%Token{
          ...
          actor_id: user_fixture().actor_id,
          context: "session"
        })
      end
    end
