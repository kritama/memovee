...
The provider runs as the Compose-managed development service in `MIX_ENV=dev`; Tama runs in the official `0.14.0-server` release image with `MIX_ENV=prod`. The Memovee integration target and derived Tama image trust the public mkcert CA needed for reciprocal HTTPS checks. The published base image digest verified for issue #11 is `sha256:92718e0cfcd1067fb253c8619b9a6eec521abc9b3229697fb007a7ed678e1b95`.
