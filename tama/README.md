...
Caddy is the public HTTPS entry point at `https://app.localhost` and `https://tama.app.localhost`. The private upstreams (http://host.docker.internal:4000 and http://tama:4000) are Docker routing details and must not be used as OAuth identities.
