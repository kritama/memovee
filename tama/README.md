...
The provider runs as the Compose-managed development service in `MIX_ENV=dev`; Tama runs in the official `0.14.2-server` release image with `MIX_ENV=prod`. The Memovee integration target and derived Tama image trust the public mkcert CA needed for reciprocal HTTPS checks. The published base image digest verified for issue #11 is `sha256:b142c3f0503674f1d9c8cc1d7bc33d316269086dab52048a0b7be4c7327f38fc`.
