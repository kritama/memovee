defmodule MemoveeWeb.SessionHelper do
  @moduledoc """
  Authenticates users from magic-link or email-password session parameters.
  """
  ...
  # magic link login
  def create_session(conn, %{"user" => %{"token" => token} = user_params}, info) do
